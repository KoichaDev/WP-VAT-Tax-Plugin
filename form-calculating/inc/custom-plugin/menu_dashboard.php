<?php
if (!function_exists('godt_sagt_form_calculation')) {

    function godt_sagt_form_calculation() {
        ...
        function init_menu() {
            echo do_shortcode('[react_form_calculation]');
        }
    }
    add_action('admin_menu', 'godt_sagt_form_calculation');
}
